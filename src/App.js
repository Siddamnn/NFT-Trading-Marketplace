...
const NFT_ADDRESS = "0xD4A3726eb3cC1a9DB9b1B7187C74350061b3361b"; // NFT contract address
const AUCTIONMANAGER_ADDRESS = "0xD35b3FB372BE6E00dE1e179821F73255E6f46a9F"; // AuctionManager contract address
...
this.setState({ auctions: new_auctions }); // Update the state
  ...
  async setActiveAuction(auction, _this) {
    // Create auction contract object
    _this._auction = new ethers.Contract( 
      auction.auctionAddress, 
      AuctionArtifact.abi, 
      _this.signer 
     );
    // Set an active auction
